/**
 * canvas_hero.js — Animación del canvas de fondo del hero
 * Cliente: Rancho Cachimba
 *
 * PLACEHOLDER: heredado de la animación de "red eléctrica" del theme
 * servelec (clonado como base estructural). El efecto visual todavía
 * no está adaptado al rubro del cliente -- pendiente de diseño.
 *
 * Cargado únicamente en páginas que incluyen ranchocachimba/components/hero.html
